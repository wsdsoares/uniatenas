	...
	<div class="">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <!-- Large modal -->                
                <?php 
               		echo anchor('painel/cadastrar_coordenadores_curso', 'Cadastrar Coordenador', array('class' => 'btn btn-primary'));
                ?>
                  ...
                  <table class="table table-striped responsive-utilities jambo_table bulk_action">
                    <thead>
                      <tr class="headings">
                        ...
                        <th class="column-title">Data Modificação</th>
                    ...
                    <?php 
		        		$dados = $this->painel->get_all('coordenadores','','nome')->result();
					?>
                    ...
                    <tbody>
						...
						<tr class="even pointer">
	                        ...
	                        $curso = $this->painel->get_byid('cursos',$linha->fk_codcurso)->row();
	                        
	                        ?>
	                        
	                        <td class=""><?php echo $curso->nome;?></td>
