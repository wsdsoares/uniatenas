                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <?php
                                echo form_open('painel/cadastrar_coordenadores_curso', array('id' => 'demo-form2', 'class' => 'form-horizontal form-label-left'));
                                ?>

                                <?php
                                $status = 1;
                                $dados = $this->inicio->get_cursos('cursos', '', 'asc')->result();
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <?php
                                        echo form_input(array('name' => 'nome', 'class' => 'form-control', 'placeholder' => 'Nome do coordenador'), set_value('nome'), 'autofocus required');
                                        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <?php
                                        echo form_dropdown(array('name' => 'fk_codcurso', 'class' => 'form-control'), $options);
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <?php
                                        echo form_input(array('name' => 'email', 'class' => 'form-control', 'placeholder' => 'Email do coordenador'), set_value('email'), 'autofocus required');
                                        ?>
