        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>CADASTRO <small>AVISO</small></h2>
			 	...
			 	?>
					...
					<div class="form-group">
						...
						<div class="col-md-8 col-sm-8 col-xs-8">
							<?php
								echo form_input(array('name' => 'titulo', 'class' => 'form-control', 'placeholder' => 'Titulo. Ex.: Perído de matrícula'), set_value('titulo'), 'autofocus required');
							?>
