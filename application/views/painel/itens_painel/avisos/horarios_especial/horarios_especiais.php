  ...
  <div class="container body">
    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
		...
		<!-- Large modal -->                
                <?php 
               		echo anchor('painel/cadastrar_horarios_especiais', 'Cadastrar Horário Especial', array('class' => 'btn btn-primary'));
                ?>	
          <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      <div class="x_title">
                        <h2>Lista de Horários Cadastrados</h2>
                        <div class="clearfix"></div>
                      </div>
                      <div class="x_content">
                        ...
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap">
                          ...
                          <tbody>
                          	...
                          	<?php
								...
								$registros = $this -> painel -> get_all('avisos') -> result();
