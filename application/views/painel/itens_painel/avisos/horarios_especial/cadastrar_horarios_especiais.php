        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>CADASTRO <small>Horário Especial</small></h2>
                ...
                <?php 
			 		echo form_open_multipart('painel/cadastrar_avisos',array('id'=>'demo-form2','class'=>'form-horizontal form-label-left')); 
			 	?>
					...
					<div class="form-group">
						...
						<div class="col-md-8 col-sm-8 col-xs-8">
							<?php
								echo form_hidden(array('name' => 'titulo', 'class' => 'form-control', 'placeholder' => 'Titulo. Ex.: Horário Especial'), set_value('titulo'), 'autofocus required');
							?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-2 col-sm-2 col-xs-12">
                      	<?php echo form_input(array('name' => 'data_inicio', 'class' => 'form-control','id'=>'datas','required'=>'required','data-inputmask'=>"'mask': '99/99/9999'"), set_value('data_inicio')); ?>
                      ...
                      <label class="control-label col-md-2 col-sm-2 col-xs-12">
                      	Data término do aviso
                      	<span class="required">*</span>
                      </label>
                       <div class="col-md-2 col-sm-2 col-xs-12">
                      	<?php echo form_input(array('name' => 'data_termino', 'class' => 'form-control col-md-7 col-xs-12','id'=>'datas','required'=>'required','data-inputmask'=>"'mask': '99/99/9999'"), set_value('data_termino')); ?>
                        <!--input name="data_aviso" id="datas" class="form-control col-md-7 col-xs-12" required="required" data-inputmask="'mask': '99/99/9999'"-->
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="exampleInputFile">Arquivos</label>
                         <?php echo form_upload(array('name' => 'arquivo', 'class' => 'input-group'), set_value('arquivo')); ?>
                        
                        <p class="help-block">Existe algum arquivo (Imagem ou PDF) que deseja colocar para o aviso? Se houver, informe-o.</p>
                    </div>	
                    <div class="form-group">
			            <div class="x_panel">
			              <div class="x_title">
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12">
                      	<?php
		                	...
		                	echo form_hidden('usuario_id', $this -> session -> userdata('user_codusuario'));
		               
		                	echo anchor('painel/avisos','Voltar', array('class' => 'btn btn-danger submit'));
