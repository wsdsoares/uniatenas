            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>CADASTRO <small>Lista de Diplomas</small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <?php
                                echo form_open_multipart('painel/cadastrar_lista_diplomas', array('id' => 'demo-form2', 'class' => 'form-horizontal form-label-left'));
                                ?>



                                <?php
                                $dados = $this->inicio->get_all('cursos', '', 'asc')->result();
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Curso
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <?php
                                        echo form_dropdown(array('name' => 'cursos_id', 'class' => 'form-control'), $options);
                                        ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <p class="help-block">Informe o aquivo PDF - Da lista dos formandos com o devido diploma.</p>
                                </div>	
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        echo form_hidden('user_id', $this->session->userdata('user_codusuario'));
