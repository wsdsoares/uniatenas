        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>CADASTRO <small>Slide Show</small></h2>
                ...
                <?php 
			 		echo form_open_multipart('painel/cadastrar_slides',array('id'=>'demo-form2','class'=>'form-horizontal form-label-left')); 
			 	?>
					...
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-9">
							<?php
								echo form_input(array('name' => 'titulo', 'class' => 'form-control', 'placeholder' => 'Título do Slide Show'), set_value('titulo'), 'autofocus required');
							?>
                    ...
                    <div class="form-group">
                        <label for="exampleInputFile">Imagem (1240 x 400)</label>
                         <?php echo form_upload(array('name' => 'arquivo', 'class' => 'input-group'), set_value('arquivo')); ?>
                        
                        <p class="help-block">Selecione o slide show que será exbido na página principal.  A resolução da imagem deverá ser <strong>1240px por 400px</strong>.</p>
                    </div>	
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12">
                       ...
                       <?php 
                       		echo anchor('painel/slides','<i class="btn btn-danger">Voltar</i>');
                       ?>
