            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>CADASTRO <small>NOTÍCIA</small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <?php
                                echo form_open_multipart('noticias/cadastrar', array('id' => 'demo-form2', 'class' => 'form-horizontal form-label-left'));
                                ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <?php
                                        echo form_input(array('name' => 'titulo', 'class' => 'form-control', 'placeholder' => 'Título da notícia'), set_value('titulo'), 'autofocus required');
                                        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div id="gender" class="btn-group" data-toggle="buttons">
                                            <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-info">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2 col-sm-2 col-xs-12">
                                        <?php echo form_input(array('name' => 'data_news', 'type' => 'date', 'class' => 'form-control col-md-7 col-xs-12', 'id' => 'datas', 'required' => 'required', 'data-inputmask' => "'mask': '99/99/9999'"), set_value('data_aviso')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <?php echo form_input(array('name' => 'url_youtube', 'class' => 'form-control col-md-7 col-xs-12', 'id' => 'datas', 'required' => 'required'), set_value('url_youtube')); ?>
                                        <!--input name="data_aviso" id="datas" class="form-control col-md-7 col-xs-12" required="required" data-inputmask="'mask': '99/99/9999'"-->
                                        <p class="help-block">Se houver vídeo para a matéria, informe aqui a URL do YouTube. Exemplo:<strong>https://www.youtube.com/watch?v=oiPzU75P9FA<h3>oiPzU75P9FA</h3></strong></p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputFile">Foto destaque</label>
                                    <span class="required">*</span>
                                    <?php echo form_upload(array('name' => 'img_destaque', 'class' => 'input-group'), set_value('img_destaque')); ?>
                                    <p class="help-block">Se houver imagem destaque, informe-a. </p>
                                </div>	
                                <div class="form-group">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2>Decrição <small> - Detalhes da notícia</small></h2>
                                            <span class="required">*</span>
                                        </div>
                                        ...
                                        <div>
                                            <?php
                                            echo form_textarea(array('name' => 'descricao', 'id' => 'editor', 'style' => 'width:100%'), set_value('descricao'))
                                            ?>
                                        </div>

                                        <span class="required">Os campos com * são campos de preenchimento obrigatórios</span>
                ...
                <!--
                        ...
                        Verificar aqui depois para verificar o como colocar calendário em padrão brasil 
