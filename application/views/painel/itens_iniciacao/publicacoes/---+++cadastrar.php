...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <h2 class="card-inside-title">comteúdos</h2>
                <div class="row clearfix">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <label for="title_short">Título LATERAL (curto)</label>
                                <input name="title_short" type="text" class="form-control" placeholder="Título (curto)" />
                            </div>
                        </div>
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <textarea name="" rows="4" class="form-control no-resize" placeholder="coloque aqui o texto da página..."></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
