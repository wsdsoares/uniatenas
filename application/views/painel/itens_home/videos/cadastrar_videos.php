            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>CADASTRO <small>VÍDEOS</small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <?php
                                echo form_open('painel/cadastrar_videos', array('id' => 'demo-form2', 'class' => 'form-horizontal form-label-left'));
                                ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <?php
                                        echo form_input(array('name' => 'titulo', 'class' => 'form-control', 'placeholder' => 'Título do vídeo'), set_value('titulo'), 'autofocus required');
                                        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <?php
                                        echo form_input(array('name' => 'url', 'class' => 'form-control', 'placeholder' => 'Url do vídeo. - COPIE DA OPÇÃO COMPARTILHAR DO YOUTUBE (estará depois do EMBED)'), set_value('url'), 'required');
                                        ?>
                                        <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                                    </div>
                                </div>
