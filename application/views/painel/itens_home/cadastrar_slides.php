                            ...
                            <div class="x_content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <?php
                                        echo form_input(array('name' => 'titulo', 'class' => 'form-control', 'placeholder' => 'Título do aviso'), set_value('titulo'), 'autofocus required');
                                        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <?php echo form_input(array('name' => 'data_aviso', 'class' => 'form-control col-md-7 col-xs-12', 'id' => 'datas', 'required' => 'required', 'data-inputmask' => "'mask': '99/99/9999'"), set_value('data_aviso')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="help-block">Existe algum arquivo que deseja colocar para o aviso? Se houver, informe-o.</p>
                                </div>	
                                <div class="form-group">
                                    <div class="x_panel">
                                        <div class="x_title">
