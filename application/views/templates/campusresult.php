...
<div>
    ...
    <style>
        ...
        main .btn-institucional, main .btn-portalprinc, main .btn-espaco-eventos, main .btn-process-enem-med {
            color: #000;
        }
        ...
        main .btn-vestibular-ead, main .btn-vestibular-agendado, main .btn-vestibular-med, main .btn-pos-graduacao, main .btn-vestibular-odontologia, main .btn-espaco-prevest, main .btn-vestibular-direito, main .btn-vestibular-enfermagem, main .btn-bolsaAtenas,  main .btn-gabarito ,main .btn-tipos  {
            color: #fff;
        }

        main .btn-vestibular-ead, main .btn-vestibular-agendado, main .btn-vestibular-med, main .btn-institucional, main .btn-portalprinc, main .btn-pos-graduacao, main .btn-espaco-eventos, main .btn-huna, main .btn-vestibular-odontologia, main .btn-contatos,   main .btn-espaco-prevest, main .btn-vesti-trad-medi, main .btn-process-enem-med, main .btn-vestibular-direito, main .btn-vestibular-enfermagem, main .btn-bolsaAtenas,  main .btn-gabarito ,main .btn-tipos  {
            ...
            <?php
                if ($dados['campus']->id == 6) {
                    ...
                    <div class="optionssite">
                        <?php
                        $link = 'http://www.atenas.edu.br/uniatenas/assets/vestibulartradicional/LISTADEAPROVADOS.pdf';
                        echo anchor( $link, '<i class="fas fa-stethoscope"></i>Lista de aprovados', array('class' => 'btn-vesti-trad-medi'));
                        ?>
                    </div>
                <?php
                }
                ...
                if ($dados['campus']->id == 6) {
                    ...
                    <div class="optionssite">
                        <?php
                         $link = 'http://www.atenas.edu.br/uniatenas/assets/vestibulartradicional/LISTADEESPERA.pdf';
                        echo anchor($link, '<i class="fas fa-book"></i>Lista de espera', array('class' => 'btn-process-enem-med'));
                        ?>
                    </div>
                <?php
                }
