                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="log-reg">
                                    ...
                                    <?php
                                    echo anchor('PortalAlunos/portais', '<i class="fa fa-lock"></i> Portal Acadêmico</a>');
                                    ?>
                                    ...
                                    <ul class="nav navbar-nav headerNew">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu sub-menu">
                                                <li>
                                                    <a href="http://localhost/projetos_faculdade/site_faculdade/inicio/missao_filosofia">
                                        ...
                                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Serviços <span class="caret"></span></a>
                                            <ul class="dropdown-menu sub-menu">
                                                ...
                                                <li>
                                                    <a href="http://www.faculdadeatenas.edu.br/Faculdade/EsCon.asp"><i class="fa fa-angle-right" aria-hidden="true"></i> Estágios e Convênios</a>
                                                </li>
                                                <hr>
                                                <li>
                                        ...
                                        <li><a href="http://localhost/projetos_faculdade/site_faculdade/inicio/ouvidoria">Contatos</a></li>
                                        <li>
                                            <?php echo anchor('Site/trabalheConosco', 'Trabalhe Conosco'); ?>
                                            <!--a href="http://localhost/projetos_faculdade/site_faculdade/inicio/ouvidoria">Trabalhe Conosco</a-->
                                        </li>
...
if ((isset($pagina) or isset($controller)) and ($controller !='Site' and $controller !='site') ) {
    ?>
