...
&noscript=1" />
  ...
  <link rel="stylesheet" type="text/css"
    href="<?php echo base_url(); ?>assets/Icon-font-7-stroke-PIXEDEN-v-1-2-0/assets/Pe-icon-7-stroke.css" media="all" />
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/style.css') . '?' . APP_VERSION_WEB; ?>"
    media="all" />

  <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/wil.css') . '?' . APP_VERSION_WEB; ?>"
    media="all" />
  <link rel="stylesheet" type="text/css"
    href="<?php echo base_url('assets/css/mega-menu.css') . '?' . APP_VERSION_WEB; ?>" media="all" />
  <link rel="stylesheet" type="text/css"
    href="<?php echo base_url('assets/css/menuWil.css') . '?' . APP_VERSION_WEB; ?>" media="all" />


  <script src="<?php echo base_url(); ?>assets/plugins/lightbox/dist/js/lightbox-plus-jquery.min.js"></script>


  <script src="<?php echo base_url(); ?>assets/plugins/vestibular/vendor/jquery/jquery.min.js" type="text/javascript">
  </script>
