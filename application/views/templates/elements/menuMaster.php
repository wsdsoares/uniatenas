            ...
            <div class="container">
              <div class="row">
                ...
                <!--
                                ...
                                ?>
                                    <div class="log-reg">
                                        <?php echo anchor('graduacao/inscricao/' . $informacoesCampus->shurtName, '  
                                            INSCREVA-SE
                                            <span><i class="fa fa-graduation-cap" aria-hidden="true"></i></span>', array('class' => "download-btn-top"));
                                        ?>
                                    </div>
                                    <?php
                                } elseif ($informacoesCampus->id == '2' or $informacoesCampus->id == '3') {
                                    $dataActual = date('Y-m-d');
                                    $dateSeteLagoas = '2019-12-08';
                                    $datePassos = '2019-12-15';
                                    if (strtotime($dataActual) <= strtotime($dateSeteLagoas) and $informacoesCampus->id == '2') {
                                    ?>
                                        <div class="log-reg">
                                            <?php echo anchor('http://www.atenas.edu.br/vestibular/vestibular/inicio', '  
                                            INSCREVA-SE
                                            <span><i class="fa fa-graduation-cap" aria-hidden="true"></i></span>', array('class' => "download-btn-top"));
                                            ?>
                                        </div>
                                        <?php
                                    } elseif (strtotime($dataActual) <= strtotime($datePassos) and $informacoesCampus->id == '3') {
                                        ?>
                                        <div class="log-reg">
                                            <?php echo anchor('http://www.atenas.edu.br/vestibular/vestibular/inicio', '  
                                            INSCREVA-SE
            ...
            <nav class="navbar">
              ...
              <div class="collapse js-navbar-collapse">
                ...
                <ul class="nav navbar-nav uniatenas-menu">
                  ...
                  <li>
                    <?php echo anchor('financeiro/inicio/' . $informacoesCampus->shurtName, 'Financeiro'); ?>
                  </li>
                  <?php
                                    if ($informacoesCampus->id == '1') {
                                    ?>
