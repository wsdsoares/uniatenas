...
$whereArraySubmenuGerais = array('pages.campusid' => $informacoesCampus->id, 'pages.pagina' => 'servicos', 'pages.status' => 1, 'pages.tipo_pagina' => 'item_geral');
$existePaginaServicosSubmenuGerais =  $this->bancosite->where(array('pages.id'), 'pages', null, $whereArraySubmenuGerais)->num_rows();
$verificaPaginaServicosSubmenuGerais =  $this->bancosite->where(array('pages.id', 'pages.title', 'pages.titulo_descritivo'), 'pages', null, $whereArraySubmenuGerais)->result();
                ...
                <ul class="nav navbar-nav uniatenas-menu">
                  ...
                  <li class="dropdown mega-dropdown">
                    ...
                    <ul class="dropdown-menu mega-dropdown-menu ">
                      ...
                      ?>
                      <li class="col-sm-6"><?php if ($existePaginaServicosSubmenuNucleos > 0) {
                                            ?>
                      <li>
                        <ul>
