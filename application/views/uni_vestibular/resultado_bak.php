  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="#consulta">Consulta EEEE</a>
        </li>
        ...
        <div class="modal-dialog modal-lg">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <embed
                src="http://www.atenas.edu.br/faculdade/paracatu/assets/files/vestibularparacatu/Gabarito-Medicina-UniAtenas-2019-paracatu.pdf"
