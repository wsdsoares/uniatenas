...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="http://www.atenas.edu.br/uniatenas/Vestibular/inicio">Início
            <?php //echo $situacaoVestibular->vestibularSituation; 
            ?> </a>
        </li>
        <?php
  ...
  <div class="container-fluid p-0 <?php echo $fundo; ?>">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex flex-column vestibular" id="consulta">
      <div class="my-auto">
        <!-- <h3 class="mb-5">Vestibular Tradicional - Medicina 2024 <br /> -->
        <h3 class="mb-5">Vestibular Tradicional - Medicina 2024 <br />
        ...
        ?>
          <div class="subheading mb-3">
            ...
            <span class="text-center">Consulta Classificação </span>
          </div>
        <?php
        }
        ?>
        ...
        <div class="col-md-12">
          <div class="text-center">
            ...
            ?>
              ...
              <input type="hidden" id="btnDataVestCampus" value="<?php echo $campusBuscaBanco; ?>" name="btnDataVestCampus" class="btn btn-info btn-lg">
