<body id="page-top">
        ...
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            ...
            <span class="d-none d-lg-block">
                ...
                if ($idCampus == 1) {
                    ...
                    ?>
                    <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="<?php echo base_url('assets/images/FaculdadeAtenasRedondo.png'); ?>">
                    <?php
                }
                ?>
            </span>
    ...
    <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="provas">
        <div class="my-auto">
            <h3 class="mb-5">Provas e Gabaritos - <?php echo $campus . '-' . $local; ?></h3>
    ...
    if ($idCampus == 1) {
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="recurso">
            <div class="my-auto">
                <h2 class="mb-5">Recurso - Prova Objetiva  - <?php echo $campus . '-' . $local; ?></h2>
