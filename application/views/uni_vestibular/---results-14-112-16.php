...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="#consulta">Consulta <?php echo $situacaoVestibular->vestibularSituation; ?> </a>
            </li>
            <?php
            if (!empty($fileListaAprovados) and $situacaoVestibular->idSituation ==5) {
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger"
                       href="<?php echo $fileListaAprovados->files; ?>">Lista aprovados</a>
                </li>
                <?php
            }
            if (!empty($fileListaEspera) and $situacaoVestibular->idSituation ==5) {
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger"
                       href="<?php echo $fileListaEspera->files; ?>">Lista Espera</a>
                </li>
                <?php
            }
            ?>
            ...
            <li class="nav-item">
                <?php
                echo anchor('http://www.atenas.edu.br/vestibular', 'Informações Vestibular', array('class' => "nav-link js-scroll-trigger"));
                ?>
            </li>
        </ul>
    </div>
...
<div class="container-fluid p-0 <?php echo $fundo; ?>">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex flex-column vestibular" id="consulta">
        <div class="my-auto">
            <h3 class="mb-5">Vestibular Tradicional Medicina 2021 <br/>
