        ...
        <div class="col-lg-5 col-md-5 col-sm-5">
            <div class="embed-responsive embed-responsive-4by3">
                <iframe class="embed-responsive-item"
                        src="https://www.youtube.com/embed/emlEe5O5-Sc" frameborder="0"
        ...
        for ($i = 0; $i < count($dados['fotosEspaco']); $i++) {
            ...
            <div class="col-sm-3">
                ...
                <div class="card card-price">
                    <div class="card-img">
                        <a href="#">
                            <img src="<?php echo base_url($dados['fotosEspaco'][$i]['photos'][0]->files); ?>"
                    ...
                    <div class="card-body">
                        ...
                        <?php echo anchor('site/fotos_espaco_eventos/' . $uricampus . '/' . $dados['fotosEspaco'][$i]['id'],
                            'Mais fotos <span class="glyphicon glyphicon-triangle-right"></span>', array('class' => "btn btn-primary btn-lg btn-block buy-now"));
                        ?>
                        </a>
                    </div>
                </div>
