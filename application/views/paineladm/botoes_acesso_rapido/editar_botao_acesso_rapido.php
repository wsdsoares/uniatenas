    ...
    <div class="card">
      ...
      <div class="body">
        <?php
          ...
          ?>
        <?php echo form_open_multipart("Painel_campus/editar_botoes_acesso_rapido/$campus->id/$botaoAcessoRapido->id") ?>
        ...
        <div class="row clearfix">
          <div class="col-md-4">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                  echo form_input(array('name' => 'title', 'class' => 'form-control', 'placeholder' => 'Título do Botão. Ex.: Site Principal'), set_value('title',$botaoAcessoRapido->title));
                ?>
              </div>
            </div>
          </div>
          <div class="col-md-8">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                  echo form_input(array('name' => 'cor_hexadecimal', 'class' => 'form-control', 'placeholder' => 'Ex.: #9400D3'), set_value('cor_hexadecimal',$botaoAcessoRapido->cor_hexadecimal));
                ?>
              </div>
            </div>
          </div>
        ...
        <div class="row clearfix" style="background:#f1f1f1">
          ...
          <div class="col-sm-5">
            ...
            <div class="input-group">
              <?php
              if($botaoAcessoRapido->arquivo!=''){
                echo '<i class="material-icons">archive</i>"';
                echo anchor(base_url($botaoAcessoRapido->arquivo),'<button type="button" class="btn btn-info"><i class="material-icons">archive</i> Ver Arquivo</button>',array('target' => '_blank'));
                }else{
        ...
        <div class="row clearfix">
          <div class="col-md-7">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                  echo form_input(array('name' => 'link_redirecionamento', 'class' => 'form-control', 'placeholder' => 'Ex.: http://www.google.com.br'), set_value('link_redirecionamento',$botaoAcessoRapido->link_redirecionamento));
                ?>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            ...
            <div class="input-group">
              ...
              <?php
              if($botaoAcessoRapido->link_redirecionamento != ''){
                echo anchor($botaoAcessoRapido->link_redirecionamento,'<a type="button" class="btn btn-info">Ver Link</button>');
              }
            ?>
            </div>
          </div>
