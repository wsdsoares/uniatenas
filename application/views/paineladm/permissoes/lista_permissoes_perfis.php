          ...
          <div class="col-sm-3">
            <div class="form-group">
              <div class="itens-permissoes">
                ...
                <div class="item">
                  <input name="visualizar-<?php echo $permissoes[$i]->titulo_curto;?>" class="marcar" type="checkbox" value="1" />
                ...
                <div class="item">
                <input name="inserir-<?php echo $permissoes[$i]->titulo_curto;?>" class="marcar" type="checkbox" value="1" />
                ...
                <div class="item">
                <input name="editar-<?php echo $permissoes[$i]->titulo_curto;?>" class="marcar" type="checkbox" value="1" />
                ...
                <div class="item">
                <input name="deletar-<?php echo $permissoes[$i]->titulo_curto;?>" class="marcar" type="checkbox" value="1" />
