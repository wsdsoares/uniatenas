  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          <?php
          if(isset($perfis) and $perfis != '' ){
          ?>
          <div class="col-xs-6">
            <?php echo anchor("Painel_financeiro/cadastrar_informacoes_financeiro", '<i class="material-icons">add_box</i> CADASTRAR item da página Financeiro', array('class' => 'btn btn-primary m-t-15 waves-effect'));?>
          </div>
          <?php 
          }
          ?>
      ...
      <div class="body">
        <div class="table-responsive">
          <table class="table table-bordered table-striped table-hover dataTable js-exportable">
            ...
            <tbody>
              <?php
              foreach ($dados['perfis'] as $item):
                  ?>
              <tr>
                <td class="center">
                  <?php 

                    echo '<a href=' . base_url("Painel_financeiro/editar_informacoes_financeiro/$item->id") . '>'
...
$('#modalDelete').on('show.bs.modal', function(e) {
  ...
  $(this).find('#btnCerteza').attr('href',
    '<?php echo base_url("Painel_financeiro/deletar_item_financeiro/"); ?>' +
    id);
});
</script>