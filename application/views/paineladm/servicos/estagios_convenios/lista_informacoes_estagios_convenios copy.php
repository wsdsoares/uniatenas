    ...
    <div class="card">
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          ...
          ?>
            <div class="col-xs-6">
              <?php echo anchor("Painel_estagios_convenios/cadastrar_informacoes_estagios_convenios/$campus->id", '<i class="material-icons">add_box</i> CADASTRAR item da página', array('class' => 'btn btn-primary m-t-15 waves-effect')); ?>
            </div>
          <?php
          }
          ?>
