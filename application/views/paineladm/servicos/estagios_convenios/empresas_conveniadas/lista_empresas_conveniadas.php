  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          <?php
          if (isset($empresasConveniadas) and $empresasConveniadas != '') {
          ?>
          <div class="col-xs-6">
            <?php echo anchor("Painel_estagios_convenios/cadastrar_empresas_conveniadas/$campus->id/$pagina->id", '<i class="material-icons">add_box</i> CADASTRAR empresa', array('class' => 'btn btn-primary m-t-15 waves-effect')); ?>
          </div>
          <?php
          }
          ?>
      ...
      <div class="body">
        <div class="table-responsive">
          <table class="table table-bordered table-striped table-hover dataTable js-exportable">
            ...
            <tbody>
              <?php
                foreach ($empresasConveniadas as $item) :
                ?>
              <tr>
                <td class="center">
                  <?php

                      echo '<a href=' . base_url("Painel_estagios_convenios/editar_empresas_conveniadas/$campus->id/$pagina->id/$item->id") . '>'
                        . '<i class="material-icons">edit</i>'
                        . '</a> ';
                      echo '<a href="" data-toggle="modal" data-target="#modalDelete" data-nome="' . $item->empresa . '" data-id="' . $item->id . '" >'
                        . '<i class="material-icons">delete</i>'
                        . '</a>';
                      ?>
                </td>
                <td><?php echo $item->id; ?></td>
                <td><?php echo "$item->empresa (<small> $item->cidade </small>)"; ?></td>
...
$('#modalDelete').on('show.bs.modal', function(e) {
  ...
  $(this).find('#btnCerteza').attr('href',
    '<?php echo base_url("Painel_estagios_convenios/deletar_empresa_conveniada/$campus->id/$pagina->id/"); ?>' +
    id);
});
</script>