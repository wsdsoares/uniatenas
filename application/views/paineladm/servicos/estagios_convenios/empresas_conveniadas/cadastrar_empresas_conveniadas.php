  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      ...
      <div class="body">
        ...
        ?>
        <?php echo form_open("Painel_estagios_convenios/cadastrar_empresas_conveniadas/$campus->id/$pagina->id") ?>
        ...
        <div class="row clearfix">
          <div class="col-md-6">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                echo form_input(array('name' => 'empresa', 'class' => 'form-control', 'placeholder' => 'Titulo'), set_value('empresa'));
                ?>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-4">
            <div class="form-group">
              <div class="form-line">
                ...
                echo form_dropdown('cityid', $opcoesCidadesConveniadas, set_value('cityid'), array('class' => 'form-control show-tick'));
                ?>
              </div>
            </div>
          </div>
