        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-2 text-center">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Itens Gerais</h5>
                  <p class="card-text"><small>(Estágio e Convênios, HUNA ou outros)</small></p>
            ...
            <div class="col-sm-2 text-center">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Núcleos</h5>
                  <p class="card-text"><small>(Núcleos - NAPP, NPJ, NPA, NPAS) ou outros</small></p>
