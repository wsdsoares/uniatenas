          ...
          <div class="col-xs-3">
            <div class="form-group">
              <div class="form-line">
                ...
                echo form_dropdown('tipo_pagina', $tipoPagina, set_value('tipo_pagina', $informacoesPagina->tipo_pagina), array('class' => 'form-control show-tick'));
                ?>
              </div>
            </div>
          </div>
          <div class="col-xs-3">
            <div class="form-group">
              <div class="form-line">
                ...
                echo form_dropdown('status', $optionSituation, set_value('status', $informacoesPagina->status), array('class' => 'form-control show-tick'));
                ?>
              </div>
            </div>
          </div>
