<?php
$paginaSecretariaStatus = $dados['paginaSecretaria'] != "" ? $dados['paginaSecretaria']->status : '';
?>
      ...
      <div class="body">
          ...
          <div class="col-sm-4">
            <div class="form-group">
              <div class="form-line">
                ...
                echo form_dropdown('status', $optionSituation, set_value('status', $paginaSecretariaStatus), array('class' => 'form-control show-tick'));
                ?>
              </div>
            </div>
          </div>
        ...
        <div class="row clearfix">
          <div class="col-sm-12">
            ...
            echo anchor("Painel_secretaria/lista_informacoes_secretaria/$campus->id", 'Voltar', array('class' => "btn btn-danger m-t-15 waves-effect"));
            ?>
          </div>
        </div>
