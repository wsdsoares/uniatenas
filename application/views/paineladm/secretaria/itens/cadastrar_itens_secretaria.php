  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      ...
      <div class="body">
        ...
        ?>
        <?php echo form_open_multipart("Painel_secretaria/cadastrar_itens_secretaria/$campus->id/$pagina->id") ?>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <div class="form-line">
                ...
                <?php
                echo form_input(array('name' => 'title', 'class' => 'form-control', 'placeholder' => 'Ex.: Apresentação da secretaria'), set_value('title'));
                ?>
              </div>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group">
              <div class="form-line">
                ...
                <?php
                echo form_input(array('name' => 'title_short', 'class' => 'form-control', 'placeholder' => 'Ex.: Apresentação do setor '), set_value('title_short'));
                ?>
              </div>
            </div>
          </div>
