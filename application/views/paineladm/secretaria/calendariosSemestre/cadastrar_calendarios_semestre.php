  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      ...
      <div class="body">
        ...
        ?>
        <?php echo form_open_multipart("Painel_secretaria/cadastrar_calendarios_semestre/$campus->id/$pagina->id") ?>
        ...
        <div class="row clearfix">
          <div class="col-sm-6">
            ...
            echo anchor("Painel_secretaria/calendarios_semestre/$campus->id/$pagina->id", 'Voltar', array('class' => "btn btn-danger m-t-15 waves-effect"));
            ?>
          </div>
        </div>
