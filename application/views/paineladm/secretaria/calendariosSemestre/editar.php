...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    <?php echo "Edição de Calendários Semestre - $namecity"; ?>
                </h2>
            </div>
            <div class="body">
                <?php
                ...
                ?>
                <?php echo form_open_multipart("Painel_secretaria/editar_calendariosSemestre/$campus/$id/$table") ?>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-sm-3">
                        ...
                        echo form_dropdown('status', $optionStatus, set_value('status',$listagem->status+1), array('class' => 'form-control show-tick')); ?>
                    </div>
                    <div class="col-sm-3">
