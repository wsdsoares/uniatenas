...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    <?php echo "Registro de Calendários Semestre - $namecity"; ?>
                </h2>
            </div>
            <div class="body">
                <?php
                ...
                ?>
                <?php echo form_open_multipart("Painel_secretaria/cadastrar_calendariosSemestre/$campus/$table") ?>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class="form-line">
                                ...
                                <?php
                                echo form_input(array('name' => 'year', 'type' => 'number', 'min' => '2000', 'max' => $ano, 'class' => 'form-control', 'placeholder' => 'Ano'), set_value('year'));
                                ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row clearfix">
                    <div class="col-sm-6">
                        ...
                        echo anchor("Painel_secretaria/calendarios_semestre/$campus", 'Voltar', array('class' => "btn btn-danger m-t-15 waves-effect"));
                        echo form_hidden('user', $this->session->userdata('codusuario'));
                        ?>
                    </div>
                </div>
