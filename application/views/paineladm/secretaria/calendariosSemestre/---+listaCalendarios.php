    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                ?>
                <h2>
                    Calendários Semestre - Campus <?php echo $campus->city?>
                </h2>
            </div>

            <div class="register">
                <?php
                echo anchor('secretaria/cadastrarCalendario/' .$campus->id, '
                            ...
                            foreach ($dados['publicacoes'] as $row) {
                                ...
                                <tr>
                                    <td class="center">
                                        ...
                                        echo '<a href="" data-toggle="modal" data-target=".bd-example-modal-lg">'
                                                . '<i class="material-icons">picture_as_pdf</i>'
                                            .'</a>'
                                            .'<a href=' . base_url("publicacoes/$row->id") . '>'
