...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    <?php echo 'REGISTRO - Calendário e provas - ' . $course->name; ?>
                </h2>
            </div>
            <div class="body">
                <?php
                ...
                ?>
                <?php echo form_open_multipart('Mural/cadastrarCalendarioProvas/' . $course->idCourseCampus) ?>
                <h2 class="card-inside-title">Informações</h2>
                <div class="row clearfix">
                    <div class="col-sm-3">
                        <label for="campusid">Tipo de calendário de prova</label>
                        <?php
                        $type = array(
                            'regular' => 'Regular',
                            'optativa' => 'Optattiva',
                        ...
                        echo form_dropdown('type', $type, set_value('type'), array('class' => 'form-control show-tick')); ?>
                    </div>
                    <div class="col-sm-2">
                        ...
                        echo form_dropdown('cycle', $typeCalendar, set_value('cycle'), array('class' => 'form-control show-tick')); ?>
                    </div>
                    <div class="col-md-4">
