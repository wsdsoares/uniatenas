    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                ?>
                <?php echo form_open_multipart('mural/editarCalendarioProvas/' . $calendar->id) ?>
                ...
                <div class="row clearfix">
                    <div class="col-sm-3">
                        ...
                        echo form_dropdown('type', $type, set_value('type',$calendar->type), array('class' => 'form-control show-tick')); ?>
                    </div>
                    <div class="col-sm-2">
