<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    Calendários de Provas <?php echo $course->name.' - '. $course->city;?>
                </h2>
            </div>
            <div class="register">
                <?php
                $pagina = 'revistas';
                echo anchor('mural/cadastrarCalendarioProvas/'.$course->idCourseCampus, '
            ...
            <div class="body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        <tbody>
                        <?php
                        foreach ($calendarsCourse as $row) {
                            ?>
                            <tr>
                                <td class="center">
                                    ...
                                    echo anchor('mural/editarCalendarioProvas/' . $row->id, '<i class="material-icons">edit</i>');
...
<script type="text/javascript">
    $('#modalDelete').on('show.bs.modal', function (e) {
        ...
        $(this).find('#btnCerteza').attr('href', '<?php echo base_url("Mural/deletarCalendariosProva/"); ?>' + id);
    });
</script>
