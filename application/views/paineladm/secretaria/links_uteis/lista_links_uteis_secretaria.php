    ...
    <div class="card">
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          ...
          <div class="col-xs-6">
            <?php echo anchor("Painel_secretaria/cadastrar_links_uteis_secretaria/$campus->id/$pagina->id", '<i class="material-icons">add_box</i> CADASTRAR Link Útil', array('class' => 'btn btn-primary m-t-15 waves-effect')); ?>
          </div>

          <div class="col-xs-6">
            <?php echo anchor("Painel_secretaria/lista_informacoes_secretaria/$campus->id", '<i class="material-icons">arrow_back</i> Voltar', array('class' => 'btn btn-warning m-t-15 waves-effect')); ?>
          </div>
        </div>
      </div>
      <br />
      <?php
      if (isset($listaLinksUteisPaginaSecretaria) and $listaLinksUteisPaginaSecretaria != '') {
      ?>
        <div class="body">
          <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
              ...
              <tbody>
                <?php
                foreach ($dados['listaLinksUteisPaginaSecretaria'] as $item) :
                ?>
                  <tr>
                    <td class="center">
                      <?php

                      echo '<a href=' . base_url("Painel_secretaria/editar_links_uteis_secretaria/$campus->id/$pagina->id/$item->id") . '>'
...
<script type="text/javascript">
  $('#modalDelete').on('show.bs.modal', function(e) {
    ...
    $(this).find('#btnCerteza').attr('href',
      '<?php echo base_url("Painel_secretaria/deletar_item_links_uteis_secretaria/$campus->id/$pagina->id/"); ?>' +
      id);
  });
</script>