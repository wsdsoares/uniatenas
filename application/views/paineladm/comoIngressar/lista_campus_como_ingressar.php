          ...
          <div class="col-md-3">
            <div class="card" style="height:10rem;padding-top:1rem;">
              <div class="center">
                ...
                <?php
                echo anchor("Painel_como_ingressar/lista_informacoes_como_ingressar/$campus->id", '<span>Ver itens de como ingressar</span>','class="btn btn-lg btn-block btn-info"');
                ?>
              </div>
            </div>
          </div>
