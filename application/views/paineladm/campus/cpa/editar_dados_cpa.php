  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      ...
      <div class="body">
        ...
        ?>
        <?php echo form_open("Painel_cpa/editar_dados_cpa/$campus->id/$conteudosPagina->id") ?>

        <h2 class="card-inside-title">Informações/ Itens CPA </h2>
        <div class="row clearfix">
          <div class="col-md-6">
            ...
            <div class="form-group">
              <div class="form-line">
                ...
                <?php
                    ...
                    echo form_dropdown('status', $optionSituation, set_value('status',$conteudosPagina->status), array('class' => 'form-control show-tick'));
                    ?>
              </div>
            </div>
          </div>
