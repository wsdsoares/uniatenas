<?php 
$contatoPaginaCpa = $dados['contatoPaginaCpa'] !="" ? $dados['contatoPaginaCpa'] : '';

if($contatoPaginaCpa != ''){
  $statusContato = $dados['contatoPaginaCpa']->status; 
  $descricaoContato = $dados['contatoPaginaCpa']->description; 
}else{
  $statusContato = '';
  $descricaoContato = '';
}
    ...
    <div class="card">
      ...
      <div class="body">
        <?php
          ...
          ?>
        <?php echo form_open("Painel_cpa/cadastrar_contato_pagina_cpa/$campus->id/$pagina->id") ?>
        ...
        <div class="row clearfix">
          <div class="col-sm-4">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                  echo form_input(array('name' => 'title', 'class' => 'form-control','readonly'=>"readonly"), set_value('title','cpa'));
                ?>
              </div>
            </div>
          </div>
