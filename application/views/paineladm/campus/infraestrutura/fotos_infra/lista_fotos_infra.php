      ...
      <div class="card">
        ...
        <div class="botoes-acoes-formularios">
          <div class="container">
            <div class="col-xs-6">
              <?php
              echo anchor("Painel_Campus/cadastrar_fotos_infraestrutura/$categoriaInfraestrutura->id/$campus->id", "<i class='material-icons'>add_box</i> Cadastro de fotos da infraestrutura", array('class' => 'btn btn-primary m-t-15 waves-effect'));
              ?>
            </div>
            <div class="col-xs-6">
              <?php 
                echo anchor("Painel_Campus/lista_infraestrutura/$campus->id", '<i class="material-icons">arrow_back</i> Voltar', array('class' => 'btn btn-warning m-t-15 waves-effect'));
              ?>
            </div>
          </div>
        </div>
        ...
        ?>
          <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
              ...
              <tbody>
                <?php
              foreach ($dados['fotosInfraestrutura'] as $foto) {
              ?>
                <tr>
                  <td class="center">
                    <?php
