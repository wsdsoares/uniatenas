<?php 
$verificaExistePagina = $dados['verificaExistePagina'] !="" ? $dados['verificaExistePagina'] : '';
?>
    ...
    <div class="card">
      ...
      <div class="body">
        <?php
          ...
          ?>
        <?php echo form_open("Painel_Campus/cadastrar_pagina_infraestrutura/$campus->id") ?>
        ...
        <div class="row clearfix">
          <div class="col-sm-4">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                  echo form_input(array('name' => 'title', 'class' => 'form-control','readonly'=>"readonly"), set_value('title','MENU - Infraestrutura'));
                ?>
              </div>
            </div>
          </div>
            ...
            <div class="form-group">
              <div class="form-line">
                ...
                <?php
                    ...
                    $status = isset($dados['paginaInfraestrutura']->status) ? $dados['paginaInfraestrutura']->status : '0';
