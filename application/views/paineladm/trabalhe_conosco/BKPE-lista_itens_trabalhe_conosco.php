    ...
    <div class="card">
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          <br />
          <div class="col-xs-6">
            <?php echo anchor("Painel_trabalhe_conosco/cadastrar_imagem_termo_aceite/$campus->id/$pagina->id", '<i class="material-icons">add_box</i> Cadastrar item da página', array('class' => 'btn btn-primary m-t-15 waves-effect')); ?>
          </div>
