    ...
    <div class="card">
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          ...
          ?>
            <div class="col-xs-6">
              <?php echo anchor("Painel_trabalhe_conosco/cadastrar_itens_trabalhe_conosco/$campus->id/$paginaTrabalheConosco->id", '<i class="material-icons">add_box</i> CADASTRAR item da página', array('class' => 'btn btn-primary m-t-15 waves-effect')); ?>
            </div>
          <?php
          }
          ?>
          <div class="col-xs-6">
            <?php echo anchor("Painel_trabalhe_conosco/lista_informacoes_trabalhe_conosco/$campus->id", '<i class="material-icons">arrow_back</i> Voltar', array('class' => 'btn btn-warning m-t-15 waves-effect')); ?>
          </div>
        </div>
      </div>
      <br />
                ...
                ?>
                  <tr>
                    <td class="center">
                      ...
                      echo '<a href=' . base_url("Painel_trabalhe_conosco/editar_itens_trabalhe_conosco/$campus->id/$paginaTrabalheConosco->id/$item->id") . '>'
                    ...
                    <td>
                      <div class="btn-opcoes-curso">
                        <?php
                        if ($item->tipo == 'imagem') {
                          echo anchor("Painel_trabalhe_conosco/lista_imagens_termo_aceite/$campus->id/$pagina->id/$item->id", 'Lista Imagens', array('class' => "btn-opcoes-curso btn btn-primary"));
                        } else {
                        }
                        ?>
                      </div>
...
<script type="text/javascript">
  $('#modalDelete').on('show.bs.modal', function(e) {
    ...
    $(this).find('#btnCerteza').attr('href',
      '<?php echo base_url("Painel_trabalhe_conosco/deletar_item_trabalhe_conosco/$campus->id/$paginaTrabalheConosco->id/"); ?>' +
      id);
  });
</script>