  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      ...
      <div class="body">
        ...
        ?>
        <?php echo form_open("Painel_trabalhe_conosco/editar_itens_trabalhe_conosco/$campus->id/$pagina->id/$paginaTrabalheConosco->id") ?>
        ...
        <div class="row clearfix">
          <div class="col-md-6">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                echo form_input(array('name' => 'title', 'class' => 'form-control', 'placeholder' => 'Titulo'), set_value('title', $paginaTrabalheConosco->title));
                ?>
              </div>
            </div>
          </div>
        ...
        <div class="row clearfix">
          <div class="col-md-6">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                echo form_input(array('name' => 'link_redir', 'class' => 'form-control', 'placeholder' => 'Link do termo de aceite'), set_value('link_redir', $paginaTrabalheConosco->link_redir));
                ?>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="form-group">
              <div class="form-line">
                ...
                <?php
                echo form_textarea(array('name' => 'description', 'class' => 'form-control', 'placeholder' => 'Explicação e inforamções pertinentes ao campus.'), toHtml(set_value('description', $paginaTrabalheConosco->description)));
                ?>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-4">
            <div class="form-group">
              <div class="form-line">
                ...
                echo form_dropdown('status', $optionSituation, set_value('status', $paginaTrabalheConosco->status), array('class' => 'form-control show-tick'));
                ?>
              </div>
            </div>
          </div>
