    ...
    <div class="card">
      ...
      <div class="body">
        <?php
         ...
         ?>
        <?php echo form_open("Painel_graduacao/cadastrar_disciplina_por_periodo/$cursoPorCampus->campus_coursesid/$cursoPorCampus->campusid/$modalidade") ?>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <div class="form-line">
                ...
                <?php
                echo form_input(array('name' => 'discipline', 'class' => 'form-control', 'placeholder' => 'Nome da Disciplina'), set_value('discipline'));
                ?>
              </div>
            </div>
          </div>
          <div class="col-sm-2">
            <div class="form-group">
              <div class="form-line">
                ...
                <?php 
                echo form_input(array('name' => 'period', 'type' => 'number', 'class' => 'form-control'), set_value('period')); 
                ?>
              </div>
            </div>
          </div>
