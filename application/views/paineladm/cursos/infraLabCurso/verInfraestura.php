<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                   Infraestrutura de laboratórios do curso - <?php echo $courses->name . ' - ' . $campus->name; ?>
                </h2>
            </div>

            <div class="register">
                <?php
                echo anchor('cursos/cadastrarInfraestrutura/' . $courses->idCourseCampus, '
                    <i class = "material-icons">
                    add
                    </i> <span>Cadastrar </span>', array('class' => 'btn btn-primary m-t-15 waves-effect'));
                ?>
                <?php
                echo anchor('cursos/informacoesCurso/' . $campus->id, '
                            <i class = "material-icons">
                            assignment_return
            ...
            <div class="body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                        ...
                        foreach ($laboratorios as $foto) {
                            ?>
                            <tr>
                                <td class="center">
                                    <?php
                                    echo '<a href="" data-toggle="modal" data-target="#modalDelete" data-nome="' . $foto->files . '" data-id="' . $courses->idCourseCampus . '-' . $foto->id . '/' . '" >'
...
<script type="text/javascript">
    $('#modalDelete').on('show.bs.modal', function (e) {
        ...
        $(this).find('#btnCerteza').attr('href', '<?php echo base_url("Cursos/deletarFoto/"); ?>' + id);
    });
</script>