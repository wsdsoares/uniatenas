            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <?php echo $item->nomeCurso . ' <br/><small><strong>(' . $item->city . ')</strong></small>'; ?>
                  ...
                  <td>
                    <div class="btn-opcoes-curso">
                      <?php
                      echo anchor("Painel_graduacao/lista_arquivos_autorizacao_reconhecimento/$item->campus_coursesid/$campus->id/$modalidade", 'Autorização/Reconhecimento', array('class' => "btn-opcoes-curso btn btn-warning"));
                      ?>
                    </div>
                    <div class="btn-opcoes-curso">
                      <?php
                  ...
                  <td>
                    ...
                    if (isset($item->filesGrid)) {
                      echo anchor($item->filesGrid, '<button type="button" class="btn btn-info" style="margin-top:50%"><i class="material-icons">archive</i> Ver Arquivo</button>', array('target' => '_blank'));
                    } else {
