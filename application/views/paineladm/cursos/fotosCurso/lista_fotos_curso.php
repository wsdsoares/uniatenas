      ...
      <div class="card">
        ...
        <div class="botoes-acoes-formularios">
          <div class="container">
            <div class="col-xs-6">
              <?php
              echo anchor("Painel_graduacao/cadastrar_fotos_curso/$cursoPorCampus->campus_coursesid/$campus->id", "<i class='material-icons'>add_box</i> Cadastro de fotos do curso", array('class' => 'btn btn-primary m-t-15 waves-effect'));
              ?>
            </div>
            <div class="col-xs-6">
              <?php 
        ...
        ?>
          <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
              ...
              <tbody>
                <?php
              foreach ($dados['fotosCurso'] as $foto) {
              ?>
                <tr>
                  <td class="center">
                    <?php
                    echo '<a href=' . base_url("Painel_graduacao/editar_foto_curso/$cursoPorCampus->campus_coursesid/$campus->id/$foto->id") . '>'
                     . '<i class="material-icons">edit</i>'
                     . '</a> ';
                     
                    echo '<a href="" data-toggle="modal" data-target="#modalDelete" data-nome="' . $foto->files . '" data-id="' .$foto->id . '/' . '" >'
                  ...
                  <td>
                    <?php 
                  echo anchor(base_url(verifyImg($foto->files)), '<img src="' . base_url(verifyImg($foto->files)) . '" class="thumbnail">', array('target' => '_blank'));
                  ?>
                  </td>
                  ...
                  <td>
                   ...
                   echo date("d/m/Y H:m:s",strtotime($dateModification)).' - '.$foto->userid; 
                    ?>
                  </td>
...
$('#modalDelete').on('show.bs.modal', function(e) {
  ...
  $(this).find('#btnCerteza').attr('href',
    '<?php 
    echo base_url("Painel_graduacao/deletar_foto_curso/$cursoPorCampus->campus_coursesid/$campus->id/"); 
    ?>' + id);
