  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      ...
      <div class="body">
        ...
        ?>
        <?php
        echo form_open_multipart("Painel_graduacao/cadastrar_fotos_curso/$cursoPorCampus->campus_coursesid/$campus->id");
        ?>
        <div class="row clearfix">
        </div>
        <div class="row clearfix">
          ...
          <div class="col-sm-4">
            <div class="form-group">
              <div class="form-line">
                ...
                <?php
                echo form_input(array('name' => 'subtitle', 'class' => 'form-control', 'placeholder' => 'Legenda'), set_value('subtitle'));
                ?>
              </div>
            </div>
          </div>
        ...
        <div class="row clearfix">
          <div class="col-md-2">
            <span> Imagens diversas do curso</span>
          </div>
          <div class="col-sm-6">
            <div class="form-group">
              <div class="form-line">
