                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            foreach ($listagem as $item):
                                ...
                                <tr>
                                    <td class="center">
                                       ...
                                       // if (in_array("regNormasIns", $permissionCampusArray['campus-1'])) {
                                        ...
                                        if(in_array("x", $permissionCampusArray['campus-1'])){
                                            echo '<a href=' . base_url("Painel_mural_digital/delete_norma_institucional/$item->id") . '>'
                                    ...
                                    <td><?php echo $type[$item->mural_typeid-1]->name; ?></td>
                                    <td><?php echo $campus[$item->campusid-1]->city; ?></td>
