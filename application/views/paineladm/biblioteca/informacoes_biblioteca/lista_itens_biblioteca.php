    ...
    <div class="card">
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          ...
          <div class="col-xs-6">
            <?php echo anchor("Painel_biblioteca/cadastrar_links_uteis_biblioteca/$campus->id/$pagina->id", '<i class="material-icons">add_box</i> CADASTRAR Link Útil', array('class' => 'btn btn-primary m-t-15 waves-effect'));?>
          </div>
      ...
      <br />
      <?php
      if(isset($listaLinksUteisPaginaBiblioteca) and $listaLinksUteisPaginaBiblioteca != '' ){
      ?>
      <div class="body">
        <div class="table-responsive">
          <table class="table table-bordered table-striped table-hover dataTable js-exportable">
            ...
            <tbody>
              <?php
              foreach ($dados['listaLinksUteisPaginaBiblioteca'] as $item):
                  ?>
              <tr>
                <td class="center">
                  <?php 

                    echo '<a href=' . base_url("Painel_biblioteca/editar_links_uteis_biblioteca/$campus->id/$pagina->id/$item->id") . '>'
