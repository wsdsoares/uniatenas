    ...
    <div class="card">
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          ...
          <div class="col-xs-6">
            <?php echo anchor("Painel_biblioteca/cadastrar_itens_comutacao_biblioteca/$campus->id/$pagina->id", '<i class="material-icons">add_box</i> CADASTRAR Item', array('class' => 'btn btn-primary m-t-15 waves-effect'));?>
          </div>
      ...
      if(isset($listaItensPaginaBiblioteca) and $listaItensPaginaBiblioteca != '' ){
      ?>
      <div class="body">
        <div class="table-responsive">
          <table class="table table-bordered table-striped table-hover dataTable js-exportable">
            ...
            <tbody>
              <?php
              foreach ($dados['listaItensPaginaBiblioteca'] as $item):
                  ?>
              <tr>
                <td class="center">
                  <?php 

                    echo '<a href=' . base_url("Painel_biblioteca/editar_itens_comutacao_biblioteca/$campus->id/$pagina->id/$item->id") . '>'
...
$('#modalDelete').on('show.bs.modal', function(e) {
  ...
  $(this).find('#btnCerteza').attr('href',
    '<?php echo base_url("Painel_biblioteca/deletar_item_comutacao_biblioteca/$campus->id/$pagina->id/"); ?>' +
    id);
});
</script>