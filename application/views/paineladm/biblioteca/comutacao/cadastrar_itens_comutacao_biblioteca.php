    ...
    <div class="card">
      ...
      <div class="body">
        <?php
          ...
          ?>
        <?php echo form_open_multipart("Painel_biblioteca/cadastrar_itens_comutacao_biblioteca/$campus->id/$pagina->id") ?>
          ...
          <div class="col-xs-3">
            <div class="form-group">
              <div class="form-line">
                ...
                <?php
                  echo form_checkbox('order', 'comutacao', set_value('order'));
                ?>
              </div>
            </div>
          </div>
