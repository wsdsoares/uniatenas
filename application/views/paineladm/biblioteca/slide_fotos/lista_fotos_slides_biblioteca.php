    ...
    <div class="card">
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          ...
          <div class="col-xs-6">
            <?php echo anchor("Painel_biblioteca/cadastrar_fotos_slides_biblioteca/$campus->id/$pagina->id", '<i class="material-icons">add_box</i> CADASTRAR Foto (slideshow)', array('class' => 'btn btn-primary m-t-15 waves-effect'));?>
          </div>
      ...
      <br />
      <?php
      if(isset($fotosSlideBiblioteca) and $fotosSlideBiblioteca != '' ){
      ?>
      <div class="body">
        <div class="table-responsive">
          <table class="table table-bordered table-striped table-hover dataTable js-exportable">
            ...
            <tbody>
              <?php
              foreach ($dados['fotosSlideBiblioteca'] as $item):
                  ?>
              <tr>
                <td class="center">
                  <?php 

                    echo '<a href=' . base_url("Painel_biblioteca/editar_fotos_slides_biblioteca/$campus->id/$pagina->id/$item->id") . '>'
...
$('#modalDelete').on('show.bs.modal', function(e) {
  ...
  $(this).find('#btnCerteza').attr('href',
    '<?php echo base_url("Painel_biblioteca/deletar_foto_slides_biblioteca/$campus->id/$pagina->id/"); ?>' +
    id);
});
</script>