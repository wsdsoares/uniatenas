...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    Lista Links Revistas e Periódicos -  <?php echo $area->title;?>
                </h2>
            </div>

            <div class="register">
                <?php
                echo anchor('biblioteca/cadastrarLinks/'.$idArea, '
                    <i class = "material-icons">
                    add
                    </i> <span>Cadastrar</span>', array('class' => 'btn btn-primary m-t-15 waves-effect'));
                ?>
                <?php
                echo anchor('biblioteca/linksRevistasPeriodicos', '
                    <i class = "material-icons">
                    arrow_back
                           ...
                           foreach ($areaslinks as $row) {
                                ...
                                <tr>
                                    <td class="center">
                                            ...
                                            echo '<a href=' . base_url("biblioteca/editarLinks/$row->id/$idArea") . '>'
...
<script type="text/javascript">
    $('#modalDelete').on('show.bs.modal', function (e) {
        ...
        $(this).find('#btnCerteza').attr('href', '<?php echo base_url("biblioteca/deletarLinks/"); ?>' + id);
    });
</script>
