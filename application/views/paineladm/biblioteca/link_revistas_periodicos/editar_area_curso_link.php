  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      ...
      <div class="body">
        ...
        ?>
        <?php echo form_open("Painel_biblioteca_revistas_periodicos/editar_area_curso_link/$campus->id/$pagina->id/$areaLink->id") ?>
          ...
          <div class="col-xs-7">
            <div class="form-group">
              <div class="form-line">
                ...
                <?php
                  echo form_input(array('name' => 'title', 'class' => 'form-control', 'placeholder' => 'Ex.: Geral / Pedagogia'), set_value('title',$areaLink->title));
                  ?>
              </div>
            </div>
          </div>
            ...
            <div class="form-group">
              <div class="form-line">
                ...
                <?php
                    ...
                    echo form_dropdown('status', $optionSituation, set_value('status', $areaLink->status), array('class' => 'form-control show-tick'));
