    ...
    <div class="card">
      ...
      <div class="body">
        <?php
          ...
          ?>
        <?php echo form_open_multipart("Painel_biblioteca/editar_itens_biblioteca/$campus->id/$pagina->id/$informacoesBibliteca->id") ?>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <div class="form-line">
                ...
                <?php
                  echo form_input(array('name' => 'title_short', 'class' => 'form-control', 'placeholder' => 'Ex.: Apresentação do setor de pesquisa '), set_value('title_short',$informacoesBibliteca->title_short));
                  ?>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <div class="form-line">
                ...
                <?php 
                echo form_input(array('name' => 'order', 'type' => 'number','min'=>'1', 'class' => 'form-control'), set_value('order',$informacoesBibliteca->order)); 
                ?>
              </div>
            </div>
          </div>
