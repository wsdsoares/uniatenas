...
if (in_array("dirigentesGereal", $permissionCampusArray['campus-1']) and in_array("regDirigentes", $permissionCampusArray['campus-1'])) {
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    ...
                    <?php
                    echo anchor('Painel_Instituicao/cadastrar_dirigentes', '<i class="material-icons">add_box</i> CADASTRAR ', array('class' => 'btn btn-primary m-t-15 waves-effect'));
                    ?>
