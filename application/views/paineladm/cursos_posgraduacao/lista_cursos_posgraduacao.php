  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      ...
      <div class="header">
        ...
        <div class="col-sm-4">
          <?php
          echo anchor("Painel_posgraduacao/cadastrar_curso_posgraduacao/$modalidade", '<i class="material-icons">add_box</i> CADASTRAR - NOVO CURSO PÓS GRADUAÇÃO ' . $modalidade, array('class' => 'btn btn-primary m-t-15 waves-effect'));
          ?>
        </div>
