...
<div class="row clearfix">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      <div class="header">
        <h2>
          <?php echo "Página Iniciação Científica - Menu PESQUISA DO SITE"; ?>

        </h2>
        <div>
          <span>
            <i><?php echo "Caso não exista a página cadastrada, não será exibido o menu 'INICIAÇÃO CIENTÍFICA' no site principal"; ?></i>
          </span>
        </div>
      </div>
      <div class="body">
          ...
          <div class="row">
            <div class="col-xs-6">
              <?php 
                ...
                echo anchor("Painel_iniciacao_cientifica/cadastrar_pagina_iniciacao_cientifica/$campus->id/", '<i class="material-icons">desktop_mac</i> '.$tituloBotao.' página (menu) <small>Iniciação Científica</small>', array('class' => 'btn alerts_info'));
              ?>
            </div>
            <div class="col-xs-6">
              <?php
              if(isset($paginaIniciacaoCientifica) and $paginaIniciacaoCientifica != '' ){
                echo anchor("Painel_iniciacao_cientifica/cadastrar_contato_pagina_iniciacao_cientifica/$campus->id/$paginaIniciacaoCientifica->id", '<i class="material-icons">contact_phone</i> '.$tituloBotao.' contatos <small>(Iniciação Científica)</small>', array('class' => 'btn btn-blue1'));
              }
              ?>
            </div>
          </div>
