<?php 
$linksUteisPaginaIniciacaoCientifica = $dados['linksUteisPaginaIniciacaoCientifica'] !="" ? $dados['linksUteisPaginaIniciacaoCientifica'] : '';

if($linksUteisPaginaIniciacaoCientifica != ''){
  $statusLinksUteis = $dados['linksUteisPaginaIniciacaoCientifica']->status; 
  $linksUteis = $dados['linksUteisPaginaIniciacaoCientifica']->description; 
}else{
  $statusLinksUteis = '';
  $linksUteis = '';
}
