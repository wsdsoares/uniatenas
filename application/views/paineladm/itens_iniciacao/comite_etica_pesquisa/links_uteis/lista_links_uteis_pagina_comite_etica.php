...
<div class="row clearfix">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      ...
      <div class="header">
        <h2>
          <?php echo "Página COMITÊ DE ÉTICA EM PESQUISA - Links Úteis"; ?>
        </h2>
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          ...
          <div class="col-xs-6">
            <?php echo anchor("Painel_pesquisa_comite/cadastrar_links_uteis_pagina_comite_etica/$campus->id/$pagina->id", '<i class="material-icons">add_box</i> CADASTRAR Link Útil', array('class' => 'btn btn-primary m-t-15 waves-effect'));?>
          </div>
      ...
      <br />
      <?php
      if(isset($listaLinksUteisPaginaComiteEtica) and $listaLinksUteisPaginaComiteEtica != '' ){
      ?>
      <div class="body">
        <div class="table-responsive">
          <table class="table table-bordered table-striped table-hover dataTable js-exportable">
            ...
            <tbody>
              <?php
              foreach ($dados['listaLinksUteisPaginaComiteEtica'] as $item):
                  ?>
              <tr>
                <td class="center">
                  <?php 

                    echo '<a href=' . base_url("Painel_pesquisa_comite/editar_links_uteis_pagina_comite_etica/$campus->id/$pagina->id/$item->id") . '>'
...
$('#modalDelete').on('show.bs.modal', function(e) {
  ...
  $(this).find('#btnCerteza').attr('href',
    '<?php echo base_url("Painel_pesquisa_comite/deletar_item_links_uteis_comite/$campus->id/$pagina->id/"); ?>' +
    id);
});
</script>