...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    Anais de Monografia - <?php echo $curso->name;?>
                </h2>
            </div>

            <div class="register">
                <?php
                echo anchor('publicacoes/salvarAnais/'.$curso->id, '
                ...
                ?>
                <?php
               /* echo anchor('publicacoes/salvar/' . $pagina, '
                    <i class = "material-icons">
                    add
                    </i> <span>Cadastrar</span>', array('class' => 'btn btn-primary m-t-15 waves-effect'));

                echo anchor('publicacoes/revistas', '<i class = "material-icons">
                    add
                    </i><span>Voltar</span>', array('class' => "btn btn-danger btn-system  m-t-15 waves-effect"));
                * 
                */
                ?>
                        ...
                        <tbody>
                            ...
                            if ($row->files == 'assets/files/magazines/<')
                                ...
                                ?>
                                    ...
                                    <td>
                                        <?php 
                                        echo $row->types."- VOL.:".$row->volume." - N". $row->number_vol ?>
                                    </td>
                                    <td><?php
