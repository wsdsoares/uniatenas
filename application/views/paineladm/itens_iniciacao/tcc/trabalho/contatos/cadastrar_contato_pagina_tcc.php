<?php 
$contatoPaginaTcc = $dados['contatoPaginaTcc'] !="" ? $dados['contatoPaginaTcc'] : '';

if($contatoPaginaTcc != ''){
  $statusContato = $dados['contatoPaginaTcc']->status; 
  $descricaoContato = $dados['contatoPaginaTcc']->description; 
}else{
  $statusContato = '';
  $descricaoContato = '';
}
    ...
    <div class="card">
      ...
      <div class="body">
        <?php
          ...
          ?>
        <?php echo form_open("Painel_pesquisa_tcc/cadastrar_contato_pagina_tcc/$campus->id/$pagina->id") ?>
        ...
        <div class="row clearfix">
          <div class="col-sm-6">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                  echo form_input(array('name' => 'title', 'class' => 'form-control','readonly'=>"readonly"), set_value('title','Trabalho de Conclusão de Curso - Item: Contato'));
                ?>
              </div>
            </div>
          </div>
