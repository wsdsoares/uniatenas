    ...
    <div class="card">
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          ...
          <div class="col-xs-6">
            <?php echo anchor("Painel_pesquisa_tcc_monografias/cadastrar_monografia/$campus->id/$pagina->id/$curso->id", '<i class="material-icons">add_box</i> CADASTRAR Monografia', array('class' => 'btn btn-primary m-t-15 waves-effect'));?>
          </div>
              ...
              <tr style="<?php echo  $estiloAlerta; ?>">
                <td class="center" >
                  <?php 
                    ...
                    echo '<a href=' . base_url("Painel_pesquisa_tcc_monografias/editar_monografia/$campus->id/$pagina->id/$item->id") . '>'
...
$('#modalDelete').on('show.bs.modal', function(e) {
  ...
  $(this).find('#btnCerteza').attr('href',
    '<?php echo base_url("Painel_pesquisa_tcc_monografias/deletar_monografia/$campus->id/$pagina->id/$curso->id/"); ?>' +
    id);
});
</script>