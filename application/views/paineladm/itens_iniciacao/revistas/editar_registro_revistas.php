    ...
    <div class="card">
      ...
      <div class="body">
        <?php
          ...
          ?>
        <?php echo form_open_multipart("Painel_publicacoes/editar_registro_revistas/$campus->id/$revista->id") ?>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <div class="form-line">
                ...
                <?php
                  echo form_input(array('name' => 'titulo', 'class' => 'form-control', 'placeholder' => 'Título'), set_value('titulo',$revista->titulo));
                  ?>
              </div>
            </div>
          </div>
        ...
        <div class="row clearfix">
          <div class="col-md-4">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                ...
                echo form_dropdown('modalidade', $modalidadeRevista, set_value('modalidade',$revista->modalidade), array('class' => 'form-control show-tick'));
                ?>
              </div>
            </div>
          </div>
          <div class="col-sm-6">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                  echo form_input(array('name' => 'linkRedirect', 'class' => 'form-control', 'placeholder' => 'Link Completo da página/sistema a ser redirecionado'), set_value('linkRedirect',$revista->linkRedirect));
                  ?>
              </div>
            </div>
          </div>
        ...
        <div class="row clearfix">
          ...
          <div class="col-sm-6">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                  echo form_input(array('name' => 'issn', 'class' => 'form-control', 'placeholder' => 'ISSN'), set_value('issn',$revista->issn));
                  ?>
              </div>
            </div>
          </div>
        ...
        <div class="row clearfix">
          <div class="col-sm-6">
            <div class="informacoes-cadastradas">
              CAPA ATUAL
              <?php
              if($revista->capa!='' and !empty($revista->capa)){
                echo anchor(base_url(verifyImg($revista->capa)), '<img src="' . base_url(verifyImg($revista->capa)) . '" class="thumbnail">', array('target' => '_blank'));
                }else{
                  echo '<span> Sem "CAPA" cadastrada. <span>';
                }
              ?>
            </div>
        ...
        <div class="row clearfix">
          <div class="col-sm-12">
            <?php
              echo form_textarea('description', to_html(set_value('description',$revista->description)));
            ?>
          </div>
