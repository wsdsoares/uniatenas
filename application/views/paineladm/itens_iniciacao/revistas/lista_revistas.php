  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      <div class="header">
        ...
        <div>
          <span>
            <i><?php echo "Caso não exista a página cadastrada, não será exibido o menu Revistas no site principal"; ?></i>
          </span>
        </div>
      </div>
      <div class="body">
        <div class="container">
          <div class="row">
            <div class="col-xs-6">
              <?php 
                if(isset($paginaRevistas) and $paginaRevistas != '' ){
                  $tituloBotao = "EDITAR";
                }else{
                  $tituloBotao = "CADASTRAR";
                }
                echo anchor("Painel_pesquisa_revistas/cadastrar_pagina_financeiro/$campus->id/", '<i class="material-icons">desktop_mac</i> '.$tituloBotao.' página (menu financeiro)', array('class' => 'btn alerts_info'));
              ?>
            </div>
    ...
    <div class="card">
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          ...
          ?>
          <div class="col-xs-6">
            <?php echo anchor('Painel_pesquisa_revistas/lista_campus_revistas', '<i class="material-icons">arrow_back</i> Voltar', array('class' => 'btn btn-warning m-t-15 waves-effect'));?>
          </div>
        </div>
      </div>
      <br />
              ...
              <tr>
                <td class="center">
                  <?php 
                    ...
                    echo '<a href=' . base_url("Painel_pesquisa_revistas/editar_informacoes_financeiro/$campus->id/$item->id") . '>'
...
$('#modalDelete').on('show.bs.modal', function(e) {
  ...
  $(this).find('#btnCerteza').attr('href',
    '<?php echo base_url("Painel_pesquisa_revistas/deletar_item_financeiro/$campus->id/"); ?>' +
    id);
});
</script>