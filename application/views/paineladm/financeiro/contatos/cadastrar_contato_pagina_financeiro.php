<?php 
$contatoPaginaFinanceiro = $dados['contatoPaginaFinanceiro'] !="" ? $dados['contatoPaginaFinanceiro'] : '';

if($contatoPaginaFinanceiro != ''){
  $statusContato = $dados['contatoPaginaFinanceiro']->status; 
  $descricaoContato = $dados['contatoPaginaFinanceiro']->description; 
}else{
  $statusContato = '';
  $descricaoContato = '';
}
        ...
        <div class="row clearfix">
          <div class="col-sm-4">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                  echo form_input(array('name' => 'title', 'class' => 'form-control','readonly'=>"readonly"), set_value('title','financeiro'));
                ?>
              </div>
            </div>
          </div>
