    ...
    <div class="card">
      ...
      <div class="body">
        <?php
          ...
          ?>
        <?php echo form_open_multipart("Painel_financeiro/editar_informacoes_financeiro/$campus->id/$paginaFinanceiro->id") ?>
        ...
        <div class="row clearfix">
          <div class="col-sm-6">
            <div class="form-group">
              <div class="form-line">
                ...
                <?php
                  echo form_input(array('name' => 'title', 'class' => 'form-control', 'placeholder' => 'Título'), set_value('title',$paginaFinanceiro->title));
                  ?>
              </div>
            </div>
          </div>
          <div class="col-sm-6">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                  echo form_input(array('name' => 'link_redir', 'class' => 'form-control', 'placeholder' => 'Link Completo da página a ser redirecionada'), set_value('link_redir',$paginaFinanceiro->link_redir));
                  ?>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <div class="form-line">
                ...
                <?php 
                echo form_input(array('name' => 'order', 'type' => 'number', 'class' => 'form-control'), set_value('order',$paginaFinanceiro->order)); 
                ?>
              </div>
            </div>
          </div>
        ...
        <div class="row clearfix"> 
          ...
          <div class="col-sm-3">
            <div class="form-group">
              <?php
                echo anchor(base_url(verifyImg($paginaFinanceiro->img_destaque)), '<img src="' . base_url(verifyImg($paginaFinanceiro->img_destaque)) . '" class="thumbnail">', array('target' => '_blank'));
                ?>
            </div>
          </div>
        </div>
            ...
            <div class="form-group">
              <div class="form-line">
                ...
                <?php
                  ...
                  echo form_dropdown('status', $optionSituation, set_value('status',$paginaFinanceiro->status), array('class' => 'form-control show-tick'));
                  ?>
              </div>
            </div>
          </div>
