        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    ...
                    <?php
                    echo anchor('Painel_home/cadastrar_financeiro', '<i class="material-icons">add_box</i> CADASTRAR ', array('class' => 'btn btn-primary m-t-15 waves-effect'));
                    ?>
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            foreach ($listagem as $item):
                                ...
                                <tr>
                                    ...
                                    <td><?php echo substr($item->description, 0, strrpos(substr($item->description, 0, 100), ' ')) . ' ...';  ?></td>
                                    <td><?php echo $item->link_redir; ?></td>
