  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          <?php
          if (isset($listaLocaisEspcacoEventos) and $listaLocaisEspcacoEventos != '') {
          ?>
            <div class="col-xs-6">
              <?php echo anchor("Painel_espacos_eventos/cadastrar_locais_eventos/$campus->id", '<i class="material-icons">add_box</i> CADASTRAR Local Espaço para Eventos', array('class' => 'btn btn-primary m-t-15 waves-effect')); ?>
            </div>
          <?php
          }
          ?>
        ...
        <div class="body">
          <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
              ...
              <tbody>
                <?php
                foreach ($dados['listaLocaisEspcacoEventos'] as $item):
                ?>
                  <tr>
                    <td class="center">
                      <?php
                    ...
                    <td>
                      ...
                      echo anchor(base_url(verifyImg($item->photocape)), '<img src="' . base_url(verifyImg($item->photocape)) . '" class="thumbnail">', array('target' => '_blank'));
                    ...
                    <td>
                      <div class="btn-opcoes-curso">
                        <?php
                        echo anchor("Painel_graduacao/lista_dados_matriz/$campus->id/", 'Fotos do Local', array('class' => "btn-opcoes-curso btn btn-success"));
                        ?>
                      </div>
                    </td>
                    <td>
