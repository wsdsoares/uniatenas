<?php
$paginaStatus = $dados['pagina'] != "" ? $dados['pagina'] : '';
?>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      ...
      <div class="body">
        ...
        ?>
        <?php echo form_open("Painel_espacos_eventos/cadastrar_pagina_espacos_eventos/$campus->id") ?>
        ...
        <div class="row clearfix">
          <div class="col-sm-4">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                echo form_input(array('name' => 'title', 'class' => 'form-control', 'readonly' => "readonly"), set_value('title', 'ITEM HOME - Espaços Eventos'));
                ?>
              </div>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="form-group">
              <div class="form-line">
                ...
                $status = isset($dados['pagina']->status) ? $dados['pagina']->status : '0';
