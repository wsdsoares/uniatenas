    ...
    <div class="card">
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          <div class="col-xs-6">
            <?php
            echo anchor("Painel_usuarios/vincular_campus_usuario/$listaUsuario->id", '<i class="material-icons">add_box</i> CADASTRAR Vinculo Campus', array('class' => 'btn btn-primary m-t-15 waves-effect'));
            ?>
          </div>
      ...
      <div class="body">
        <div class="table-responsive">
          <table class="table table-bordered table-striped table-hover dataTable js-exportable">
            ...
            <tbody>
              <?php
              foreach ($dados['vinculoUsuario'] as $item){
                  ?>
              <tr>
                <td class="center">
                  <?php 
                  echo '<a href="" data-toggle="modal" data-target="#modalDelete" data-nome="' . $item->city . '" data-id="' . $item->id . '" >'
                ...
                <td> <?php echo date("d/m/Y H:i:s",strtotime($item->created_at)).' '.$item->user_id; ?></td>
...
$('#modalDelete').on('show.bs.modal', function(e) {
  ...
  $(this).find('#btnCerteza').attr('href',
    '<?php echo base_url("Painel_usuarios/deletar_vinculo_usuario/$listaUsuario->id/"); ?>' + id);
});
</script>