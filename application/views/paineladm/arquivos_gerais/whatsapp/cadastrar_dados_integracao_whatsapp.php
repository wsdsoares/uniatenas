  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      ...
      <div class="body">
        ...
        ?>
        <?php echo form_open("Painel_geral/cadastrar_dados_integracao_whatsapp/$campus->id") ?>
        ...
        <div class="row clearfix">
          <div class="col-md-3">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                  echo form_input(array('name' => 'titulo_botao', 'class' => 'form-control', 'placeholder' => 'Titulo do botão', 'maxlength'=>25), set_value('titulo_botao'));
                ?>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                  echo form_input(array('name' => 'numero_whatsapp', 'class' => 'form-control', 'placeholder' => 'Número do telefone. Ex.: 5538999999999'), set_value('numero_whatsapp'));
                ?>
              </div>
            </div>
          </div>
        ...
        <div class="row clearfix">
          <div class="col-md-5">
            <label for="title">Tempo do efeito <small> (movimento do botão)<br />(Número em segundos) <br />Padrão 40
              </small></label>
            <div class="input-group">
              <span class="input-group-addon">
              ...
              <div class="form-line">
                <?php
                  echo form_input(array('name' => 'tempo_interacao_segundos', 'class' => 'form-control', 'placeholder' => 'Tempo em SEGUNDOS', 'type'=>'number'), set_value('tempo_interacao_segundos'));
                ?>
              </div>
            </div>
          </div>
        ...
        <div class="row clearfix">
          <div class="col-md-12">
            ...
            <div class="input-group">
              ...
              <div class="form-line">
                <?php
                  echo form_input(array('name' => 'texto_padrao_mensagem', 'class' => 'form-control', 'placeholder' => 'Texto da mensagem inicial'), set_value('texto_padrao_mensagem'));
                ?>
              </div>
            </div>
          </div>
