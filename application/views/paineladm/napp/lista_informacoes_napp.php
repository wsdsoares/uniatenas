...
<div class="row clearfix">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      <div class="header">
        <h2>
          <?php echo "Página Núcleo de Apoio Piscopedagógico - Menu NAPP DO SITE"; ?>
          ...
          <div class="row">
            <div class="col-xs-6">
              <?php 
                ...
                echo anchor("Painel_napp/cadastrar_pagina_napp/$campus->id/", '<i class="material-icons">desktop_mac</i> '.$tituloBotao.' página (menu Napp)', array('class' => 'btn alerts_info'));
              ?>
            </div>
            <!-- <div class="col-xs-6">
              <?php
    ...
    <div class="card">
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          ...
          ?>
          <div class="col-xs-6">
            <?php echo anchor("Painel_napp/cadastrar_informacoes_napp/$campus->id", '<i class="material-icons">add_box</i> CADASTRAR item da página NAPP', array('class' => 'btn btn-primary m-t-15 waves-effect'));?>
          </div>
          <?php 
          }
          ?>
          <div class="col-xs-6">
            <?php echo anchor('Painel_napp/lista_campus_napp', '<i class="material-icons">arrow_back</i> Voltar', array('class' => 'btn btn-warning m-t-15 waves-effect'));?>
          </div>
        </div>
      </div>
      <br />
...
$('#modalDelete').on('show.bs.modal', function(e) {
  ...
  $(this).find('#btnCerteza').attr('href',
    '<?php echo base_url("Painel_napp/deletar_item_napp/$campus->id/"); ?>' +
    id);
});
</script>