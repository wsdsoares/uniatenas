    ...
    <div class="card">
      ...
      <div class="botoes-acoes-formularios">
        <div class="container">
          ...
          <div class="col-xs-6">
            <?php echo anchor("Painel_portal_alunos/cadastrar_itens_portal_alunos/$campus->id/$pagina->id", '<i class="material-icons">add_box</i> CADASTRAR Item', array('class' => 'btn btn-primary m-t-15 waves-effect')); ?>
          </div>
                ...
                ?>
                  <tr>
                    <td class="center">
                      ...
                      echo '<a href=' . base_url("Painel_portal_alunos/editar_itens_portal_alunos/$campus->id/$pagina->id/$item->id") . '>'
...
<script type="text/javascript">
  $('#modalDelete').on('show.bs.modal', function(e) {
    ...
    $(this).find('#btnCerteza').attr('href',
      '<?php echo base_url("Painel_portal_alunos/deletar_item_portal_alunos/$campus->id/$pagina->id/"); ?>' +
      id);
  });
</script>