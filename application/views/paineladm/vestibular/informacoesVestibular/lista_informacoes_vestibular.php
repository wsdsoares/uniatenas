  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      <div class="header">
        ...
        <?php
        $page = $this->uri->segment(2);
        echo anchor("Painel_vestibular/cadastrar_informacoes_vestibular/$campus->id", '<i class="material-icons">add_box</i> CADASTRAR ', array('class' => 'btn btn-primary m-t-15 waves-effect'));
        ?>
      </div>
      <br>
      <div class="body">
