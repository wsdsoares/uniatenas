<?php
if ($tipo == 'provaGab') {
    $opname = $provaGab->title;
    $optype = $provaGab->typeid;
}
if ($tipo == 'files') {
    $opname = $provaGab->name;
    $optype = $provaGab->typesid;
}
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        <?php echo 'EDIÇÃO DE ARQUIVOS VESTIBULAR' ?>
                    </h2>
                </div>
                <div class="body">
                    <?php
                    ...
                    ?>
                    <?php echo form_open_multipart("Painel_vestibular/editar_vestfiles/$item/$tipo") ?>
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <?php
                                    echo form_input(array('name' => 'title', 'class' => 'form-control', 'placeholder' => 'Titulo'), set_value('title', $opname));
                                    ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            echo form_dropdown('type', $optiontypes, set_value('type', $provaGab->typesid), array('class' => 'form-control show-tick')); ?>
                        </div>
                    </div>
                    <div class="row clearfix">
                        <div class="col-sm-3">
