                                        ...
                                        <div class="imgDescription" style="float:left;">
                                            ...
                                            <div class="">
                                                <div class="imagemCourseEad">
                                                    <img src="<?php echo base_url() . $curso->imagem; ?>"
                                                         alt="courses"
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-4 col-md-6 wow fadeInUp"
                                        ...
                                        <div class="boxcoordenador boxitens" style="height: 100px;">
                                            <div class="icon">
                                                <a href="<?php echo base_url($dados['informacoesCurso']->filesGrid); ?>"
                                                   target="_blank"><i
                                    ...
                                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                                        ...
                                        <a href="<?php echo base_url($dados['informacoesCurso']->recognition); ?>"
                                           target="_blank"></a>
                                        <div class="icon">
                                            <a href="<?php echo base_url($dados['informacoesCurso']->recognition); ?>"
                                               target="_blank"><i class="fas fa-gavel"></i></a>
                                        </div>
                                        <h4 class="title">
                                            <a href="<?php echo base_url($dados['informacoesCurso']->recognition); ?>"
                                               target="_blank">Ato de Autorização / Reconhecimento</a>
                                        </h4>
                                        <a href="<?php echo base_url($dados['informacoesCurso']->recognition); ?>"
                                           target="_blank">
                                            <img src="<?php echo base_url('assets/images/icons/pdf.png'); ?>"/>
