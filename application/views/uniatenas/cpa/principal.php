            ...
            <div class="col-sm-2">
                <ul class="nav nav-pills brand-pills nav-stacked" role="tablist">
                    ...
                    <!--li role="presentation" class="brand-nav">
                        <a href="#tab4" aria-controls="tab4" role="tab" data-toggle="tab4">Resultados</a>
                    </li-->
                    <!--li role="presentation" class="brand-nav">
                        <a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">Histórico</a>
                    </li>
                    <li role="presentation" class="brand-nav">
                        <a href="#tab4" aria-controls="tab3" role="tab" data-toggle="tab">Objetivos</a>
                    </li>
                    <li role="presentation" class="brand-nav">
                        <a href="#tab4" aria-controls="tab4" role="tab" data-toggle="tab">Composição</a>
                    </li>
                    <li role="presentation" class="brand-nav">
                        <a href="#tab5" aria-controls="tab5" role="tab" data-toggle="tab">Resultados</a>
                    </li-->
                </ul>
            </div>
            <div class="col-sm-7">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-sm-5 col-xs-6">
                                            ...
                                            <div class="card text-center boxSite" id="teste">
                                                <a href="http://www.atenas.edu.br/uniatenas/assets/temps/temp_resultado.pdf"
