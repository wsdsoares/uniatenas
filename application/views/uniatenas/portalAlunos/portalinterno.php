        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-sm-4 mb-3">
                <div class="card text-white bg-totvs">
                    <a class="card-body text-white" href="http://177.69.195.6:8000/web/app/edu/PortalEducacional/login">
                        <div class="card-body-icon">
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body-portal">
                        <a href="#">
                            <img src="<?php echo base_url('assets/images/portais/horario_aula.png'); ?>"
                                 class="img-responsive">
                        </a>
                    </div>
                </div>
            ...
            <div class="col-sm-2">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body-portal">
                        <a href="http://177.69.195.6:8080/portalatenas/painel" target="_blank">
                            <img src="<?php echo base_url('assets/images/portais/plano_ensino.png'); ?>"
                                 class="img-responsive">
                        </a>
                    </div>
                </div>
            ...
            <div class="col-sm-2">
                <div class="panel panel-info">
                    ...
                    ?>
                    <div class="panel-body-portal">
                        <img src="<?php echo base_url('assets/images/portais/mapas_sala.png'); ?>"
                             class="img-responsive"/>
                    </div>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body-portal">
                        <a href="http://177.69.195.6/Corpore.Net/Main.aspx?ActionID=EduEmitirRelatoriosActionWeb&SelectedMenuIDKey=mnEmitirRelatoriosEdu"
                           target="_blank">
