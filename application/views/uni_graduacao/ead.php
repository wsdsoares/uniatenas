                                ...
                                <div class="col-sm-6">
                                    <li>
                                        <figure>
                                            ...
                                            <img src="<?php echo base_url($row['capa']); ?>"
                                                 alt="<?php echo $row['name']; ?>" class="img-responsive">
                                            <figcaption>
                    ...
                    <div class="item-inner">
                        ...
                        <ul class="grid cs-style-3">
                            ...
                            <!--div class="col-sm-6">
                                <li>
                                    <figure>
                                        <h4 class="title-ead">EaD - Uniasselvi</h4>
                                        <img src="<?php echo base_url('assets/images/courses/ead/ead-uniasselvi.jpg'); ?>"
                                             alt="EaD - Uniasselvi" class="img-responsive">
                                        <figcaption>
                                            <h4 class="titleCourse">EaD - Uniasselvi</h4>
                                            <a href="http://dribbble.com/shots/1115960-Music?list=users">Ver todos os
                                                cursos</a>
                                        </figcaption>
                                    </figure>
