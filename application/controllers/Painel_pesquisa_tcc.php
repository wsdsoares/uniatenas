...
class Painel_pesquisa_tcc extends CI_Controller {
  ...
  public function lista_campus_tcc() {
    verificaLogin();
    ...
    $data = array(
      'titulo' => 'UniAtenas',
      'conteudo' => 'paineladm/itens_iniciacao/lista_campus_tcc',
      'dados' => array(
        'page' => "Informações Menu (PESQUISA >> Trabalho de Conclusão de Curso)",
