...
class Vestibular extends CI_Controller
{
    ...
    public function resultado_geral()
    {
        ...
        if ($idCampus == 1) {
            $tabela = 'paracatu_2023_12_resultados';
            $resultadosOficiais = count($this->bancoVestibular->getWhere($tabela)->result());
        } elseif ($idCampus == 2) {
            $tabela = 'setelagoas_2023_12_resultados';
            $resultadosOficiais = count($this->bancoVestibular->getWhere($tabela)->result());
        } elseif ($idCampus == 3) {
            $tabela = 'passos_2023_12_resultados';
            $resultadosOficiais = count($this->bancoVestibular->getWhere($tabela)->result());
        } elseif ($idCampus == 6) {
            $tabela = 'valenca_2023_12_resultados';
            $resultadosOficiais = count($this->bancoVestibular->getWhere($tabela)->result());
        } elseif ($idCampus == 7) {
            $tabela = 'sorriso_2023_12_resultados';
            $resultadosOficiais = count($this->bancoVestibular->getWhere($tabela)->result());
        } elseif ($idCampus == 8) {
            $tabela = 'porto_seguro_2023_12_resultados';
            $resultadosOficiais = count($this->bancoVestibular->getWhere($tabela)->result());
        }
        ...
        $whereEssay = array($tabela, $tabela . '.ano' => '2024', $tabela . '.' . $fieldQuery => $infCandidato);
        ...
        $data = array(
            'head' => array(
                'title' => 'Vestibular 2024 - Medicina',
            ),
            'conteudo' => 'uni_vestibular/resultado_geral',
            'js' => 'js_result',
            'footer' => '',
    ...
    public function resultFinal($cpfCandidato, $idCampus, $tabela, $actionVestibular)
    {
        ...
        $hash = $dadosCandidato->posicao . '-' . $dadosCandidato->inscricao . $anoAtual . $dadosCandidato->cpf;
        ...
        if ($actionVestibular == 'consultaNotaRedacao') {
            ...
            if ($idCampus == '1') {
                $img_fundo = 'http://www.atenas.edu.br/uniatenas/assets/images/vestibular/ConsultadeClassificacaoParacatu.jpg';
            } elseif ($idCampus == '2') {
                $img_fundo = 'http://www.atenas.edu.br/uniatenas/assets/images/vestibular/ConsultadeClassificacaoSete.jpg';
            } elseif ($idCampus == '3') {
                $img_fundo = 'http://www.atenas.edu.br/uniatenas/assets/images/vestibular/ConsultadeClassificacaoPassos.jpg';
            } elseif ($idCampus == '6') {
                $img_fundo = 'http://www.atenas.edu.br/uniatenas/assets/images/vestibular/ConsultadeClassificacaoValenca.jpg';
            } elseif ($idCampus == '7') {
                $img_fundo = 'http://www.atenas.edu.br/uniatenas/assets/images/vestibular/ConsultadeClassificacaoSorriso.jpg';
            } elseif ($idCampus == '8') {
                $img_fundo = 'http://www.atenas.edu.br/uniatenas/assets/images/vestibular/ConsultadeClassificacaoPorto.jpg';
            }
